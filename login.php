...
/* Define username and associated password array */$logins = array('Put here the username' => 'Put here the password');
...
<title><?php print$current_dir_name==''?'Database: Login':$current_dir_name?></title>
</form>
